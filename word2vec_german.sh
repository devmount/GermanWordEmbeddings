...
# python training.py corpus_psub/ model/corpus-psub_SG-100-5.model -s 100 -w 5
# python training.py corpus_psub/ model/corpus-psub_SG-200-5.model -s 200 -w 5
...
# python evaluation.py -u model/corpus-psub_CB-52-5.model
# python evaluation.py -u model/corpus-psub_CB-52-10.model
# python evaluation.py -u model/corpus-psub_CB-52-15.model
python evaluation.py -u model/corpus-psub_CB-52-20.model
